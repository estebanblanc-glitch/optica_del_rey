(function () {
  ...
  const defaultSiteData = {
    business: {
      ...
      stockText: "Trabajamos con una selección amplia de armazones, cristales y lentes de contacto. Escribinos y te confirmamos opciones, colores y disponibilidad.",
